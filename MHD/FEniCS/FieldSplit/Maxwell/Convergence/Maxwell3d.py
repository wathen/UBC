...
for xx in xrange(1,m):
    ...
    # if case == 1:
    #     u0 = Expression(("x[1]*x[1]*(1-x[1])*x[2]*x[2]*(1-x[2])","x[0]*x[0]*(1-x[0])*x[2]*x[2]*(1-x[2])","x[0]*x[0]*(1-x[0])*x[1]*x[1]*(1-x[1])"))
    #     p0 = Expression("x[1]*(x[1]-1)*x[0]*(x[0]-1)*x[2]*(x[2]-1)")
    ...
    c = 0
    # if case == 1:
    #     CurlCurl = Expression(("x[2]*x[2]*(1-x[2])*(6*x[1]-2)+x[1]*x[1]*(1-x[1])*(6*x[2]-2)","x[2]*x[2]*(1-x[2])*(6*x[0]-2)+x[0]*x[0]*(1-x[0])*(6*x[2]-2)","x[1]*x[1]*(1-x[1])*(6*x[0]-2)+x[0]*x[0]*(1-x[0])*(6*x[1]-2)"))
    #     gradR = Expression(("(2*x[0]-1)*x[1]*(x[1]-1)*x[2]*(x[2]-1)","(2*x[1]-1)*x[0]*(x[0]-1)*x[2]*(x[2]-1)","(2*x[2]-1)*x[0]*(x[0]-1)*x[1]*(x[1]-1)"))
    f = CurlCurl + gradR
