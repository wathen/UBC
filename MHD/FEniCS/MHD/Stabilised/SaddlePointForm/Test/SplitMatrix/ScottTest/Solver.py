...
def solve(A,b,u,params, Fspace,SolveType,IterType,OuterTol,InnerTol,HiptmairMatrices,Hiptmairtol,KSPlinearfluids, Fp,kspF,Options):
    ...
    if SolveType == "Direct":
        ...
        if IterType == "Full":
            ...
            pc.setPythonContext(MHDprec.ApproxInvApprox(FFSS,kspF, KSPlinearfluids[0], KSPlinearfluids[1],Fp, HiptmairMatrices[3], HiptmairMatrices[4], HiptmairMatrices[2], HiptmairMatrices[0], HiptmairMatrices[1], HiptmairMatrices[6],Hiptmairtol,Options))
            #OptDB = PETSc.Options()
