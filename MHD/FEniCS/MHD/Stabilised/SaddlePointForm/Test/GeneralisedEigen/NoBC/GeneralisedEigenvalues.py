...
def eigensORIG(A,AA, W, PCD, L):
    ...
    print FX.todense()
    A = sp.bmat([[F,Ct,Bt,None],[Ct.transpose(),M,None,Dt],[Bt.transpose(),None,None,None],[None,Dt.transpose(),None,None]])
    ...
    Papprox = sp.bmat([[FX,Ct,Bt,None],[None,MX,None,  Dt],[None,None,-PCD,None],[None,None,None,L]])
