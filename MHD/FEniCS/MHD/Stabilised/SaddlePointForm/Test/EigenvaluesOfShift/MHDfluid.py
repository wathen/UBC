...
for xx in xrange(1,m):
    ...
    MU = 1.0/10
    IterType = 'Full'
    path = 'FLUIDmatrix_kappa='+str(kappa)+'_nu_m='+str(Mu_m)+'_nu='+str(MU)
    ...
    b_is = PETSc.IS().createGeneral(range(Velocity.dim(),Magnetic.dim()+Velocity.dim()))
    ...
    while eps > tol  and iter < maxiter:
        ...
        if IterType == "CD":
            ...
            #a = kappa*kappa/Mu_m*inner(mat*b_t,c_t)*dx(W.mesh()) 
