...
for xx in xrange(1,m):
    ...
    path = 'STOKESmatrix_kappa='+str(kappa)+'_nu_m='+str(Mu_m)+'_nu='+str(MU)
    ...
    ns,maxwell,CoupleTerm,Lmaxwell,Lns = forms.MHD2D(mesh, W,F_M,F_NS,
            u_k,b_k,params,IterType,"DG", SaddlePoint = "Yes",Stokes = "Yes")
    RHSform = forms.PicardRHS(mesh, W, u_k, p_k, b_k, r_k,
            params,"DG",SaddlePoint = "Yes", Stokes = "yes")
