...
The resulting preconditioners have a similar block structure, however the approximations for $\mathcal{K}^{-1}_{\rm M}$ and $\mathcal{X}^{-1}_{\rm NS}$ are slightly different.
