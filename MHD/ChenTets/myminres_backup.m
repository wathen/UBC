...
function [x,flag,relres,iter,resvec,resveccg] = myminres(A,b,tol,maxit,M1,M2,x0,W11,A11,B11,varargin)
%MINRES    Minimum Residual Method
%   X = MINRES(A,B) attempts to find a minimum norm residual solution X
%   to the system of linear equations A*X=B.  The N-by-N coefficient matrix
%   A
%   must be symmetric but need not be positive definite.  The right hand
%   side column vector B must have length N.  A may be a function returning
%   A*X.
%
...
%
%   MINRES(AFUN,B,TOL,MAXIT,M1FUN,M2FUN,X0,P1,P2,...) passes parameters
%   P1,P2,...
...
if existM1
   ...
   if isequal(m1type,'matrix')
      vold1 = vold(1:n11,1);
      vold2 = vold(n11+1:end,1);
      %[u11,flag1,relres1,iter1,resvec1] = mypcg(A11,vold1,1e-1,1000,speye(n11),[],[],W11,B11); 
           
      u11=vold1;
      [u22,flag2,relres2,iter2,resvec2] = pcg(W11,vold2,1e-1,2000); 
      flag2,iter2
...
if existM1
   if isequal(m1type,'matrix')
      ...
      vold2 = vold(n11+1:end,1);
      %[u11,flag1,relres1,iter1,resvec1] = mypcg(A11,vold1,1e-1,1000,speye(n11),[],[],W11,B11); 
      %[u11,flag1,relres1,iter1,resvec1] =   pcg(A11,vold1,1e-12,1000);
      %flag1,iter1
      ...
      %[u11,flag1,relres1,iter1,resvec1] = mypcg(A11,vold1,1e-12,1000,[],[],[],W11,B11);
      %u22 = W11 \ vold2;
      u = [u11; u22];
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
